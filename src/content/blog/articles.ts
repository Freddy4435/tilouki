...
export const blogArticles: BlogArticle[] = [
  ...
  },
  {
    ...
    metaDescription:
      "Une liste simple pour composer une petite garde-robe bébé utile, douce et facile à utiliser les premiers mois.",
    category: "bebe",
    readingTime: "5 min",
    ...
    content: [
      ...
      "La bonne garde-robe bébé est celle que l'on utilise vraiment. Des pièces douces, faciles à associer et faciles à entretenir permettent de gagner du temps tout en gardant un univers tendre.",
    ].join("\n\n"),
    keyTakeaways: [
      "Body + pyjama = base de la garde-robe bébé.",
  ...
  },
  {
    ...
    keyTakeaways: [
      ...
      "Un bon rangement rend la garde-robe plus facile à utiliser.",
    ],
  },
  {
