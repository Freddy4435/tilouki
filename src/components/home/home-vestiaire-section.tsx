...
function VestiaireCatalogueFallback() {
  return (
    <div className="border-tilouki-argile/30 bg-tilouki-argile-soft/25 space-y-4 rounded-[var(--radius-card)] border p-5 sm:p-6">
      ...
      <ArrivageNewsletterCta source="arrivage-accueil" className="mt-4" />
    </div>
  );
}
