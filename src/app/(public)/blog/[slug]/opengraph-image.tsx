...
export const alt = "Article — Le Carnet Tilouki";
...
export default async function BlogOpenGraphImage({ params }: BlogOpenGraphImageProps) {
  ...
  const title = article?.title ?? "Le Carnet Tilouki";
  const category = article ? getBlogCategoryLabel(article.category) : "Conseils enfants";
  const description =
